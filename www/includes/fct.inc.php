...
{
    // @ pour dire que c'est une liste
    // explode : elever, donc on enleve le / 
...
{
    //preg_match: fonction qui verifie que le valeur sont bien de 0 à 9 strictement positif 
...
function estDateValide($date)
{
    ...
    if (count($tabDate) != 3) {
        ...
        if (!estTableauEntiers($tabDate)) {
            ...
            //checkdate: Valide une date grégorienne mois/jour/annee
